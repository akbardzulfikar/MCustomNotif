...
import co.id.mcustomnotif.NotificationService.Companion.CHANNEL_ID
import co.id.mcustomnotif.NotificationService.Companion.CHANNEL_NAME
import co.id.mcustomnotif.NotificationService.Companion.REPLY_ACTION
...
class ReplyActivity : AppCompatActivity() {
    ...
    private fun sendMessage(notifyId: Int, messageId: Int) {
        ...
        val message = edit_reply.toString().trim { it <=' ' }
